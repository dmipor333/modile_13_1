...
async def start_tournament():
    task1 = asyncio.create_task(start_strongman('Владимир', 4))
    task2 = asyncio.create_task(start_strongman('Иван', 5))
    task3 = asyncio.create_task(start_strongman('Сергей', 6))
    await task1
    await task2
    await task3
